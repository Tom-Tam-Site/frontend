                  ...
                  <div className="pt-4 col-lg">
                    <div className="paragraph">
                      <span className="bolded-inline">
                        Without a target (goal) to aim for, it is impossible for
                        a business or an individual to succeed. Creating a
                        vision and setting goals aligned with that vision is an
                        imperative first step toward achieving desired outcomes.
                      </span>
                      <span>
                        This time-tested principle was taught thousands of years
                        ago with this quote in Proverbs, “Where there is no
                    ...
                    <div className="paragraph">
                      ...
                      <span>
                        Like an architect drafting a blueprint of a house to be
                        built, the conceptualization of what the house looks
                        like upon completion enables subsequent steps and
                        project management to ensure the house is built to
                        specifications.
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="pt-4 col-lg">
                    <div className="paragraph">
                      <span className="bolded-inline">
                        ...
                        is important for businesses as well as individuals to be
                        properly aligned with those targets.
                      </span>
                      <span>
                    ...
                    <div className="paragraph">
                      ...
                      <span>
                        There is much heavy lifting to be done in this phase to
                        appreciate resource requirements, as well as the “
                  ...
                  <div className="pt-4 col-lg">
                    <div className="paragraph">
                      ...
                      <div>
                        ...
                        leadership competencies include team orientation, active
                        listening, and ability to scale from big picture to
                        leading by example in the trenches.
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="pt-4 col-lg">
                    <div className="paragraph">
                      ...
                      <span>
                        ...
                        constantly aligned and realigned with goals and desired
                        outcomes.
                      </span>
                      <span className="bolded-inline-surrounded">
                        A crucial element is establishing performance metrics
                        and key indicators that have causal relationship to the
                        desired outcomes.
                      </span>
                      <span>
